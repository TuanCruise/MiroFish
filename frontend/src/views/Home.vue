  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">{{ $t('home.subtitle') }}</span>
          ...
          <div class="hero-desc">
            <p>
              {{ $t('home.desc1') }}<span class="highlight-bold">MiroFish</span>{{ $t('home.desc2') }}<span class="highlight-orange">{{ $t('home.desc3') }}</span>{{ $t('home.desc4') }}<span class="highlight-code">{{ $t('home.desc5') }}</span>
            </p>
            <p class="slogan-text">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <h2 class="section-title">{{ $t('home.readyStatus') }}</h2>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                ...
                <span class="console-meta">{{ $t('home.supportFormat') }}</span>
              </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  :disabled="loading"
                ></textarea>
                <div class="model-badge">{{ $t('home.engineVer') }}</div>
              </div>
            </div>
