        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>WithReport AgentConversation</span>
            </button>
            ...
            >
              ...
              <span>Send a questionnaire to the world</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick dialogue version of the report generation agent, callable 4 Type of professional tool, possessingMiroFishComplete memory of</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligning real-world seed data with simulated environment states, in combinationGlobal/Local MemoryMechanism, providing deep cross-temporal and cross-spatial attribution analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Breadth-first traversal algorithm based on graph structures, reconstructing event propagation paths and capturing the topological structure of the full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Based on GraphRAG Real-time query interface, optimizing index efficiency for quickly extracting specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that can conduct multi-turn dialogues concurrently with individuals in the simulated world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'With Report Agent Dialogue, delve into the report content' : 'Dialogue with simulated individuals to understand their perspectives' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the questions you want to ask all selected subjects..."
                rows="3"
              ></textarea>
            </div>
...
const chatHistoryCache = ref({}) // Cache all dialogue records: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
// Save the current dialogue record to cache
...
const selectReportAgentChat = () => {
  // Save the current dialogue record
  saveChatHistory()
  ...
  // Restore Report Agent Chat history of
...
const renderMarkdown = (content) => {
  ...
  // Processing List - Supports sublists
  ...
  // Clean whitespace after the start tag of the list
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Clear the whitespace before the list end tag
  ...
  // Clean before and after block-level elements <br> Tag
  html = html.replace(/<br>\s*(<ul|<ol|<blockquote)/g, '$1')
  html = html.replace(/(<\/ul>|<\/ol>|<\/blockquote>)\s*<br>/g, '$1')
  // Clean <p><br> Cases immediately following block-level elements (caused by extra blank lines)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clearing consecutive <br> Tag
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Before the paragraph start tag immediately following cleaned block-level elements <br>
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering of non-continuous ordered lists: when a single item <ol> When separated by paragraph content, keep numbering incrementing
...
const sendMessage = async () => {
  ...
  try {
    ...
    scrollToBottom()
    // Automatically save dialogue records to cache
    saveChatHistory()
  }
}

const sendToReportAgent = async (message) => {
  addLog(`To Report Agent Send: ${message.substring(0, 50)}...`)
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    // Correct data path: res.data.result.results Is a dictionary object
    // Format: {"twitter_0": {...}, "reddit_0": {...}} Or Single Platform {"reddit_0": {...}}
    const resultData = res.data.result || res.data
    const resultsDict = resultData.results || resultData
    
    // Convert the object dictionary to an array, prioritizing obtaining reddit Platform responses
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Preferential Use reddit Platform reply, secondly twitter
...
const submitSurvey = async () => {
  ...
  addLog(`Send questionnaire to ${selectedAgents.value.size} Object...`)
...
/* Left Panel - Report Style (With Step4Report.vue Exact Match) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* Fix ordered list numbering - Use CSS Counters allowing multiple ol Sequential Numbering */
.message-text {
...
/* Chat/Citation style of the questionnaire area */
