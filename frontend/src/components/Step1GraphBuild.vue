    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLMAnalyze the document content and simulation requirements, extract real-world seeds, and automatically generate an appropriate ontology structure.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically segment the document and then invoke. Zep Build a knowledge graph, extract entities and relationships, and generate temporal memory and community summaries.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">The graph construction is complete, please proceed to the next step to set up the simulation environment.</p>
          <button 
            class="action-btn" 
