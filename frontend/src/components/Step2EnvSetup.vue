<template>
  <div class="env-setup-panel">
    <div class="scroll-container">
      <!-- Step 01: simulation example -->
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">01</span>
            <span class="step-title">Simulate instance initialization</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            NewsimulationExample, fetch simulation world parameter template
          </p>
      ...
      <!-- Step 02: Generate Agent character setting -->
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">02</span>
            <span class="step-title">Generate Agent character setting</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the context, automatically invoke tools to extract entities and relationships from the knowledge graph, initialize simulated individuals, and endow them with unique behaviors and memories based on real-world seeds.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Current number of topics associated with the real seed</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">Already generated Agent character setting</span>
            </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM Based on simulation requirements and real-world seeds, intelligently set parameters such as world time flow speed, recommendation algorithm, each individual's active time periods, speaking frequency, event triggers, etc.
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              ...
              <div class="time-periods">
                ...
                <div class="period-item">
                  <span class="period-label">Morning time slot</span>
                  <span class="period-hours">{{ simulationConfig.time_config?.morning_hours?.[0] }}:00-{{ simulationConfig.time_config?.morning_hours?.slice(-1)[0] }}:00</span>
                  <span class="period-multiplier">×{{ simulationConfig.time_config?.morning_activity_multiplier }}</span>
                </div>
                <div class="period-item">
                  <span class="period-label">low period</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                ...
                <span class="config-block-badge">{{ simulationConfig.agent_configs?.length || 0 }} a</span>
              </div>
                ...
                >
                  ...
                  <div class="agent-params">
                    ...
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Sentiment orientation</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="phase === 3" class="badge processing">In layout</span>
            <span v-else class="badge pending">Wait</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Based on the narrative direction, automatically generate initial activation events and hot topics to guide the initial state of the simulated world.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Simulation round configuration - Only displayed after the configuration generation is complete and the round count has been calculated. -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation round setting</span>
                <span class="section-desc">MiroFish Automatic Planning and Inference of Reality <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> Hour, each round represents reality. <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> Minutes pass</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>ifAgentScale is100：Estimated time about {{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">If this is your first run, it is strongly recommended to switch to “custom mode” and reduce the number of simulation rounds, so you can quickly preview the results and lower the risk of errors. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              ...
              <span class="info-value">{{ selectedProfile.age || '-' }} year</span>
            </div>
            <div class="info-item">
              <span class="info-label">Event's apparent gender</span>
              <span class="info-value">{{ { male: 'male', female: 'woman', other: 'Other' }[selectedProfile.gender] || selectedProfile.gender }}</span>
            </div>
            <div class="info-item">
          ...
          <div class="modal-section">
            <span class="section-label">Character profile summary</span>
          ...
          <!-- Detailed character setting -->
          <div class="modal-section" v-if="selectedProfile.persona">
            <span class="section-label">Detailed character background</span>
            
            <!-- Overview of character design dimensions -->
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">Panoramic event experience</span>
                <span class="dim-desc">The complete behavior trajectory in this incident</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavioral profiling</span>
                <span class="dim-desc">Experience Summary and Preferred Working Style</span>
              </div>
              <div class="dimension-card">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Individual Links and Interaction Map</span>
              </div>
            </div>
...
const props = defineProps({
  simulationId: String,  // Pass in from the parent component
  projectData: Object,
  graphData: Object,
  systemLogs: Array
})
...
// State
const phase = ref(0) // 0: Initialize, 1: Generate a character profile, 2: Generate configuration, 3: Completed
...
// Log deduplication: record the key information from the previous output
...
const customMaxRounds = ref(40)   // Default recommendation40wheel

// Watch stage to update phase
watch(currentStage, (newStage) => {
  if (newStage === 'GenerateAgentcharacter setting' || newStage === 'generating_profiles') {
    phase.value = 1
  } else if (newStage === 'Generate simulation configuration' || newStage === 'generating_config') {
    phase.value = 2
    // Enter the configuration generation phase, start polling the configuration
    if (!configTimer) {
      addLog('Begin generating dual-platform simulation configuration...')
      startConfigPolling()
    }
  } else if (newStage === 'Prepare a simulation script' || newStage === 'copying_scripts') {
    phase.value = 2 // still in the configuration stage
  }
})

// Calculate the automatically generated number of rounds from the configuration (without using hardcoded default values)
const autoGeneratedRounds = computed(() => {
  ...
  // Ensure the maximum number of rounds is not less than40（Recommended value), avoid abnormal slider range
...
// Calculate the total number of related topics for all character settings.
...
const handleStartSimulation = () => {
  // Construct parameters passed to the parent component
  const params = {}
  
  if (useCustomRounds.value) {
    // User-defined number of rounds, pass max_rounds Parameters
    params.maxRounds = customMaxRounds.value
    addLog(`Start simulation, custom number of rounds: ${customMaxRounds.value} wheel`)
  } else {
    // User chooses to keep the automatically generated number of rounds, without passing. max_rounds Parameters
    addLog(`Start simulation, using automatic configuration rounds: ${autoGeneratedRounds.value} wheel`)
  }
...
const startPrepareSimulation = async () => {
  ...
  // Mark the first step completed, start the second step
  phase.value = 1
  addLog(`Simulation instance has been created: ${props.simulationId}`)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected that the preparation work has already been completed, use it directly.')
        await loadPreparedData()
        return
      }
      
      taskId.value = res.data.task_id
      addLog(`Preparation task has started`)
      addLog(`  └─ Task ID: ${res.data.task_id}`)
      
      // Set expectations immediatelyAgentTotal (fromprepareInterface return value retrieval
      if (res.data.expected_entities_count) {
        expectedTotal.value = res.data.expected_entities_count
        addLog(`fromZepGraph read ${res.data.expected_entities_count} an entity`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (data.status === 'completed' || data.status === 'ready' || data.already_prepared) {
        addLog('✓ The preparatory work has been completed')
        stopPolling()
        stopProfilesPolling()
        await loadPreparedData()
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Only when API Update only when returning a valid value to avoid overwriting existing valid values.
      ...
      // output Profile Generate progress log (only when quantity changes)
      ...
      if (currentCount > 0 && currentCount !== lastLoggedProfileCount) {
        ...
        if (currentCount === 1) {
          addLog(`Start generatingAgentcharacter setting...`)
        }
        addLog(`→ Agentcharacter setting ${currentCount}/${total}: ${profileName} (${latestProfile?.profession || 'Unknown occupation'})`)
        
        // If all generation is complete
        if (expectedTotal.value && currentCount >= expectedTotal.value) {
          addLog(`✓ All ${currentCount} aAgentCharacter setting generation completed`)
        }
      }
    }
  } catch (err) {
    console.warn('Obtain Profiles Failure:', err)
  }
}
...
const fetchConfigRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Output configuration generation stage logs (avoid duplication)
      if (data.generation_stage && data.generation_stage !== lastLoggedConfigStage) {
        lastLoggedConfigStage = data.generation_stage
        if (data.generation_stage === 'generating_profiles') {
          addLog('GeneratingAgentCharacter setting configuration...')
        } else if (data.generation_stage === 'generating_config') {
          addLog('CallingLLMGenerate simulation configuration parameters...')
        }
      }
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          addLog(`  ├─ AgentQuantity: ${data.summary.total_agents}a`)
          addLog(`  ├─ Simulation duration: ${data.summary.simulation_hours}hour`)
          addLog(`  ├─ Initial post: ${data.summary.initial_posts_count}item`)
          addLog(`  ├─ Hot topics: ${data.summary.hot_topics_count}a`)
        ...
        if (data.config.time_config) {
          ...
          addLog(`Time configuration: Each round${tc.minutes_per_round}minutes, together${Math.floor((tc.total_simulation_hours * 60) / tc.minutes_per_round)}wheel`)
        }
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('✓ The environment setup is complete, you can start the simulation.')
        emit('update-status', 'completed')
      }
    }
  } catch (err) {
    console.warn('Obtain Config Failure:', err)
  }
}
...
const loadPreparedData = async () => {
  ...
  // Get it one last time Profiles
  await fetchProfilesRealtime()
  addLog(`Loaded ${profiles.value.length} aAgentcharacter setting`)
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        // Show detailed configuration summary
        if (res.data.summary) {
          addLog(`  ├─ AgentQuantity: ${res.data.summary.total_agents}a`)
          addLog(`  ├─ Simulation duration: ${res.data.summary.simulation_hours}hour`)
          addLog(`  └─ Initial post: ${res.data.summary.initial_posts_count}item`)
        }
        ...
        addLog('Configuration generation in progress, starting polling, waiting....')
        startConfigPolling()
      }
    }
  } catch (err) {
