...
Used to persist project state on the server side to avoid passing large amounts of data between frontend interfaces
"""
...
class Project:
    ...
    # Ontology info (filled after API 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph info (filled after API 2 completion)
...
class ProjectManager:
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Returns:
            Project list, reverse order by creation time
        """
        cls._ensure_projects_dir()
