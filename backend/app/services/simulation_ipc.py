...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specific platform (optional)
                ...
                - None: Interview both platforms during dual-platform simulation, corresponding platform during single platform simulation
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, will be overridden by platform of each interview item)
                - "twitter": Default to interview only Twitter platform
                - "reddit": Default to interview only Reddit platform
                - None: Each Agent interviews both platforms during dual-platform simulation
            timeout: Timeout
    ...
    def check_env_alive(self) -> bool:
        ...
        Judged by checking the env_status.json file
        """
...
class SimulationIPCServer:
    ...
    def poll_commands(self) -> Optional[IPCCommand]:
        """
        Poll commands directory, returns the first pending command
