"""
Report API Routes
Provides APIs for simulation report generation, retrieval, dialogue, etc.
"""
...
def generate_report():
    ...
    try:
        ...
        if not simulation_requirement:
            return jsonify({
                "success": False,
                "error": "Missing simulation requirements"
            }), 400
        ...
        return jsonify({
            ...
            "data": {
                ...
                "task_id": task_id,
                "status": "generating",
                "message": "Report generation task started, please use /api/report/generate/status to check progress",
...
def get_generate_status():
    ...
    try:
        ...
        # If simulation_id is provided, check if completed report exists first
        if simulation_id:
            existing_report = ReportManager.get_report_by_simulation(simulation_id)
            if existing_report and existing_report.status == ReportStatus.COMPLETED:
                return jsonify({
...
def list_reports():
    ...
    Query Params:
        ...
        limit: Limit number of returned results (default 50)
...
def delete_report(report_id: str):
    ...
    try:
        ...
        return jsonify({
            "success": True,
            "message": f"Report object deleted: {report_id}"
        })
...
# ============== Report Progress and Sections APIs ==============
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this API to get generated section content without waiting for the whole report
...
def get_agent_log(report_id: str):
    ...
    Real-time retrieval of every step in the report generation process, including:
...
def stream_agent_log(report_id: str):
    """
    Get full Agent log (get all at once)
...
def get_console_log(report_id: str):
    ...
    This is a plain-text console-style log, different from the structured JSON log returned by the agent-log API.
